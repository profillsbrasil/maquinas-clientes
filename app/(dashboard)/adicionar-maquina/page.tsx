        ...
        <div className='flex gap-4 w-full h-full justify-evenly'>
          <div className='relative w-1/2'>
            ...
            <div className='absolute top-0 left-0 w-full h-full bg-slate-800/50 grid grid-cols-20 '>
              ...
              <X className='absolute size-8 top-2 left-12 flex justify-center items-center z-10 rounded-full bg-slate-800/40 text-white hover:bg-slate-800/90 ' />
            </div>
          </div>
          <div className='flex flex-col gap-4 max-w-[30rem] pt-30'>
            ...
            <Button
              variant='outline'
              className='w-full rounded-sm  hover:bg-slate-700/90 hover:text-white flex items-center justify-center bg-slate-800 text-white border-border/20'>
